//1. Handles Google Cloud Storage file interactions 
...
const rawVideoBucketName = "OG-raw-videos";
const processedVideoBucketName = "OG-processed-videos";
...
export function convertVideo(rawVideoName: string, processedVideoName: string){
     ...
     * @return A purpose that resolves when the file has been downloaded.
     */
